...
\begin{figure}
    \centering
    \includegraphics[width = .6\textwidth]{Figures/refl_setup.pdf}
...
\begin{figure}
    \centering
\includegraphics[width = .6\textwidth]{Figures/flat_sample.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{Figures/square_tiles.pdf}
